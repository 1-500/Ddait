...
const IndicatorWrapper = React.forwardRef<React.ElementRef<typeof View>, React.ComponentProps<typeof View>>(
  ({ ...props }, ref) => {
    return <View {...props} ref={ref} />;
  },
);

const LabelWrapper = React.forwardRef<React.ElementRef<typeof Text>, React.ComponentProps<typeof Text>>(
  ({ ...props }, ref) => {
...
const UIRadio = createRadio({
  Root: (Platform.OS === 'web'
    ...
    : withStyleContextAndStates(Pressable, SCOPE)) as ReturnType<typeof withStyleContextAndStates<typeof Pressable>>,
  Group: View,
...
const RadioGroup = React.forwardRef<React.ElementRef<typeof UIRadio.Group>, IRadioGroupProps>(
  ({ className, ...props }, ref) => {
...
const RadioIndicator = React.forwardRef<React.ElementRef<typeof UIRadio.Indicator>, IRadioIndicatorProps>(
  ({ className, ...props }, ref) => {
...
const RadioLabel = React.forwardRef<React.ElementRef<typeof UIRadio.Label>, IRadioLabelProps>(
  ({ className, ...props }, ref) => {
    const { size } = useStyleContext(SCOPE);
    return (
      <UIRadio.Label
...
const RadioIcon = React.forwardRef<React.ElementRef<typeof UIRadio.Icon>, IRadioIconProps>(
