...
const TextareaWrapper = React.forwardRef<React.ElementRef<typeof View>, React.ComponentProps<typeof View>>(
  ({ ...props }, ref) => {
...
const TextareaInput = React.forwardRef<React.ElementRef<typeof UITextarea.Input>, ITextareaInputProps>(
  ({ className, ...props }, ref) => {
